    ...
    <div class="container-fluid justify-content-center" style="margin-top: 100px;">
        <div class="row align-content-center">
            ...
            <div class="col-12 p-5">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 d-block">
                        <div class="row g-3">
                            <div class="col-12">
                                <p class="title2" style="margin-top: 50px;">Sign In to your Account</p>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <a href="index.php" class="btn btn-danger">Back to customer login</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 fixed-bottom text-center">
                ...
                <p class="fw-bold">&copy;Enchant</p>
            </div>
