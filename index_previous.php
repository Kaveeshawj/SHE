        ...
        <div class="row align-content-center">
            ...
            <div class="col-12 p-3">
                <div class="row">
                    ...
                    <!-- signup -->
                    <div class="col-12 col-lg-6 pl-2" id="signUpBox">
                        <div class="row g-2">
                            <div class="col-12">
                            ...
                            <div class="col-12 d-none" id="msgdiv">
                                <div class="alert alert-danger" role="alert" style="background-color: #F64C4C; color: black;" id="alertdiv">
                    ...
                    <div class="col-12 col-lg-6 d-none" id="signInBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn btn-danger" onclick="changeView();">New to she?Join Now</button>
                            </div>
                    ...
                    <div class="col-12 fixed-bottom d-none d-lg-block">
                        <p class="text-center">&copy; 2022 she.lk || All Rights Reserved</p>
                    </div>
