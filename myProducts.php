    ...
    <body style="background-color: #E9EBEE;">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 " style="background-color: #FFB3C6;min-height: 120px">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <button onclick="window.location='addProduct.php'" class="btn btn-primary">Add Product</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-11 col-lg-2 mx-3 my-3 border rounded" style="background-color: #FAE6E7;">
                            <div class="row">
                        ...
                        <div class="col-12 col-lg-9 mt-3 mb-3" style="background-color: #FAE6E7;">
                                        ...
                                        <div class="card mb-3 mt-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-md-4 mt-4">
                                                    ...
                                                    ?>
                                                    <img src="<?php echo $product_img_data["code"]; ?>" class="img-fluid rounded-start imgcat" />
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" role="switch" id="fd<?php echo $selected_data["id"]; ?>" onchange="changeStatus(<?php echo $selected_data['id']; ?>);" <?php if ($selected_data["status_id"] == 1) { ?> checked <?php } ?> />
                                                            <label class="form-check-label fw-bold text-info" for="fd<?php echo $selected_data["id"]; ?>">
                                                                <?php if ($selected_data["status_id"] == 1) { ?> Make Your Product Dective <?php
                                                                                                                                        } else {
                    ...
                    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 text-center mb-2">
                                <label class="col-12 form-label fs-1 fw-bold">You haven't added any items yet.</label>
                            </div>
                            <div class="offset-lg-4 col-12 col-lg-4 d-grid mb-3">
                                <a href="addProduct.php" class="btn  fs-3 fw-bold" style="background-color: #D14F7B;" >Add Product</a>
                            </div>

                            <!-- <div class="col-12 col-lg-2 mx-2 mb-2 my-lg-4 mx-lg-0 d-grid">
                                    <button onclick="window.location='addProduct.php'" class="btn btn-primary"></button>
                                </div> -->
                        </div>
                    </div>
                    <?php
