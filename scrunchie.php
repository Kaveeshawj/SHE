        ...
        <div class="row">
            ...
            <div class="container-fluid mb-5" style="background-color: #FFB3C6;">
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
                    <h1 class="fw-bold text-uppercase mb-3 fs-1">Scrunchies </h1>
                    <div class="d-inline-flex">
                        <p class="m-0"><a href="home.php">Home</a></p>
                        <p class="m-0 px-2">-</p>
                        <p class="m-0">Scrunchies</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid pt-5">
                <div class="row px-xl-5">
                    ...
                    <div class="col-12 ms-3 rounded mb-2" style="background-color: #FFE5EC;" id="basicSearchResult">
                        <div class="row gap-2">
                            <div class="">
                                <div class="row justify-content-center gap-1" id="viewArea">
