...
if(isset($_SESSION["u"])){
    ...
    if(isset($_FILES["image"])){
        ...
        $allowed_image_extensions = array("image/jpg","image/jpeg","image/jpg","image/png","image/svg+xml");
        $file_ex = $image["type"];

        if(!in_array($file_ex,$allowed_image_extensions)){        //compare
            ...
            if($file_ex == "image/jpg"){
                $new_fiel_extension = ".jpg";
            }else if($file_ex == "image/jpeg"){
                $new_fiel_extension = ".jpeg";
            }else if($file_ex == "image/png"){
                $new_fiel_extension = ".png";
            }else if($file_ex == "image/svg+xml"){
                $new_fiel_extension = ".svg+xml";
            }

            $file_name = "resources/profile image/".$_SESSION["u"]["fname"]."_".uniqid().$new_fiel_extension;
