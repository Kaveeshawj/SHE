                        ...
                        <div class="col-12 mt-3">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $cart_rs = Database::search("SELECT * FROM `cart` WHERE `cart`.`user_email`='" . $umail . "'");
                                    ...
                                    ?>
                                        ...
                                        <tr style="height: 72px;">
                                            <td class="text-dark fs-3" style="background-color: #FF8FAB;">00<?php echo $pid ?></td>
                                            <td>
                                                <span class="align-middle fs-5"> </br><?php echo ($product_data["title"]); ?></td>

                                            </td>
                                            <td class="fw-bold fs-6 text-end pt-3 text-dark" style="background-color: #FF8FAB;">Rs. <?php echo $product_data["price"]; ?> .00</td>
                                            <td class="fw-bold fs-6 text-end pt-4 "><?php echo $cart_data["qty"]; ?></td>
                                            <?php
                                            $tot = $product_data["price"] * $cart_data["qty"];
                                            $sub_tot = $tot + $sub_tot;
                                            ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-end">Rs. <?php echo $sub_tot; ?> .00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end border-dark" style="color: #7F5539;">Rs. <?php echo $g; ?> .00</td>
                                    </tr>
                                </tfoot>
