...
<head>
    ...
    <title>Purchasing History | SHE</title>
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 text-center mb-5">
                    <span class="fs-1 fw-bold text-dark">Purchasing History</span>
                </div>
                ...
                ?>
                    <div class="col-12 text-center" style="height: 450px;background-color: #FAE6E7;">
                            ...
                            ?>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-start" style="background-color: #FF8FAB;">
                                            <label class="form-label text-dark fs-6 py-5">000<?php echo $invoice_data["id"]; ?></label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-2 text-center text-lg-end" style="background-color: #FF8FAB;">
                                            <label class="form-label fs-4 py-5 text-dark">Rs. <?php echo $invoice_data["total"]; ?> .00</label>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-dark mt-5 fs-5" onclick="addFeedback(<?php echo $invoice_data['product_id']; ?>);">
                                                        <i class="bi bi-info-circle-fill"></i> Feedback
                                                    </button>
                                                </div>
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-primary rounded mt-5 fs-5">
