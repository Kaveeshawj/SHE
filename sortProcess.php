            ...
            <div class="card mb-3 mt-3 col-12 col-lg-6">
                <div class="row">
                    <div class="col-md-4 mt-4">
                        ...
                        <img src="<?php echo $profile_image_data["code"]; ?>" class="img-fluid rounded-start">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="fd<?php echo $selected_data["id"]; ?>" <?php if ($selected_data["status_id"] == 1) { ?>checked<?php } ?> onclick="changeStatus(<?php echo $selected_data['id']; ?>); " />
                                ...
                                <div class="col-12">
                                    <div class="row g-2">
                                        <div class="col-12 col-lg-6 d-grid">
                                            <a href="updateProduct.php" class="btn btn-success fw-bold ">Update</a>
                                        </div>
                                        <div class="col-12 col-lg-6 d-grid">
